			...
			<tbody class="d-none">
				...
				<tr id="product-{{ $currentStockEntry->product_id }}-row"
					...
					<td class="fit-content border-right">
						<a class="permission-STOCK_CONSUME btn btn-primary btn-sm product-consume-button @if($currentStockEntry->amount_aggregated < $currentStockEntry->quick_consume_amount || $currentStockEntry->enable_tare_weight_handling == 1) @endif"
							href="#"
							data-toggle="tooltip"
							data-placement="left"
						...
						<a id="product-{{ $currentStockEntry->product_id }}-consume-all-button"
							class="permission-STOCK_CONSUME btn btn-outline-info btn-sm product-consume-button @if($currentStockEntry->amount_aggregated == 0) disabled @endif"
							href="#"
							data-toggle="tooltip"
