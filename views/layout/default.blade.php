...
<body class="fixed-nav @if(boolval($userSettings['night_mode_enabled_internal'])) night-mode @endif @if($embedded) embedded @endif">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item discrete-link"
                            ...
                            @if (strpos(GROCY_USER_USERNAME, 'admin') === 0)
                                ...
                                <a class="dropdown-item discrete-link"
                                    data-toggle="modal"
                                    data-target="#dailypoupFormModal">
                                    <i class="fa-solid fa-fw fa-bell"></i>&nbsp;{{ $__t('每日弹窗') }}
                                </a>
                                <!--弹出每日弹窗表单-->
                            @endif
	...
	@endif
    <!--每日弹窗模态表单-->
    <div class="modal  fade" id="dailypoupFormModal" tabindex="-1" role="dialog" aria-labelledby="dailypoupModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="dailypoupFormModalLabel">每日弹窗</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="dailypoupForm">
     
                        <div class="form-group">
                            <label for="dailypoupContent">内容</label>
                            <textarea class="form-control wysiwyg-editor" id="dailypoupContent" name="content" rows="15" cols="100" placeholder="请输入内容"></textarea>
                        </div>
                        <!--是否开启弹窗-->
                        <div class="form-group">
                            <label for="dailypoupIsOpen">是否开启弹窗</label>
                            <select class="form-control" id="dailypoupIsOpen" name="is_open">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" class="dailypoupCloseButton">关闭</button>
                    <button type="button" class="btn btn-primary" id="dailypoupSaveButton">保存</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal  fade" id="dailypoupModal" tabindex="-1" role="dialog" aria-labelledby="dailypoupModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="dailypoupModalLabel">お疲れ様です。</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="dailypoupCloseButton">スキップ</button>
                    <button type="button" class="btn btn-primary" id="dailypoupCloseOverDayButton">本日通知なし</button>
                </div>
            </div>
        </div>
    </div>
	...
	<script src="{{ $U('/packages/bootbox/bootbox.js?v=', true) }}{{ $version }}"></script>
